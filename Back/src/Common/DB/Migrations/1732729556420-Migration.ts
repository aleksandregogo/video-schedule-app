...
export class Migration1732729556420 implements MigrationInterface {
    name = 'Migration1732729556420'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "media" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "uuid" uuid NOT NULL, "upload_complete" boolean NOT NULL DEFAULT false, "key" character varying(500) NOT NULL, "bucket_name" character varying(50) NOT NULL, "format" character varying(20) NOT NULL, "size" integer NOT NULL, "duration" character varying(20), "campaign_id" integer, "user_id" integer, CONSTRAINT "UQ_2d6760ea1f49ca137ddc33620b1" UNIQUE ("uuid"), CONSTRAINT "PK_f4e0fcac36e050de337b670d8bd" PRIMARY KEY ("id")); COMMENT ON COLUMN "media"."format" IS 'format of tracks. (MP4)'; COMMENT ON COLUMN "media"."duration" IS 'Total duration of the composition.'`);
