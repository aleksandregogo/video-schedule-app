...
export class Migration1733661914096 implements MigrationInterface {
    name = 'Migration1733661914096'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "booking" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'PENDING', "screen_id" integer, "user_id" integer, CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "campaign" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "uuid" uuid NOT NULL, "name" character varying(100) NOT NULL, "screen_id" integer NOT NULL, "company_id" integer NOT NULL, "user_id" integer NOT NULL, "media_id" integer, CONSTRAINT "UQ_5401d34520c7747d2cfff228e48" UNIQUE ("uuid"), CONSTRAINT "PK_0ce34d26e7f2eb316a3a592cdc4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "booking" ADD CONSTRAINT "FK_580c2b421ec62ef81b50f3022c6" FOREIGN KEY ("screen_id") REFERENCES "screen"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "booking" DROP CONSTRAINT "FK_580c2b421ec62ef81b50f3022c6"`);
